...
void advection(PARA_DATA *para, REAL **var, int var_type, REAL *d, REAL *d0)
{
  ...
  ---------------------------------------------------------------------------*/
	...
	//	printf("iteration1 is %f \t %f \t %f \t %d \t %d \t%d \n", w0, OL[Z], z[IX(i,j,k)],OC[Z],k,COOD[Z] );
...
void XLOCATION(PARA_DATA *para, REAL **var, REAL *flag, REAL *x, REAL u0, int i, int j, int k,  REAL *OL, int *OC, int *LOC , int *COOD)
	{
	        ...
	        {  OC[X] -=1;
              ...
              {  
	           ...
	           ratio_k= (u[IX(OC[X]+1,OC[Y],OC[Z])]-u[IX(OC[X],OC[Y],OC[Z])])/(x[IX(OC[X]+1,OC[Y],OC[Z])]-x[IX(OC[X],OC[Y],OC[Z])]);
			     if(u[IX(OC[X]+1,OC[Y],OC[Z])]>0 && u[IX(OC[X]+1,OC[Y],OC[Z])] != u[IX(OC[X],OC[Y],OC[Z])] )
			       {
				   ...
				   if (OL[X]<x[IX(OC[X],OC[Y],OC[Z])]) OL[X]=x[IX(OC[X],OC[Y],OC[Z])];
			       }
			     else
	   ...
	   {
	       if(OL[X]>x[IX(OC[X]+1,OC[Y],OC[Z])]&& LOC[X] == 1)
           {
	          OC[X] +=1;
			  if(OL[X] <=x[IX(OC[X]+1,OC[Y],OC[Z])]) COOD[X]=0;
              if(flag[IX(OC[X]+1,OC[Y],OC[Z])]>0)
              {  
	            delta_t= (dt- (x[IX(i,j,k)]-x[IX(OC[X],OC[Y],OC[Z])])/u0)*tratio;
	            ratio_k= (u[IX(OC[X]+1,OC[Y],OC[Z])]-u[IX(OC[X],OC[Y],OC[Z])])/(x[IX(OC[X]+1,OC[Y],OC[Z])]-x[IX(OC[X],OC[Y],OC[Z])]);
				if(u[IX(OC[X],OC[Y],OC[Z])]<0 && u[IX(OC[X]+1,OC[Y],OC[Z])] != u[IX(OC[X],OC[Y],OC[Z])] )
				  {
                    const_bk= (u[IX(OC[X],OC[Y],OC[Z])]*x[IX(OC[X]+1,OC[Y],OC[Z])]-u[IX(OC[X]+1,OC[Y],OC[Z])]*x[IX(OC[X],OC[Y],OC[Z])])/(u[IX(OC[X]+1,OC[Y],OC[Z])]-u[IX(OC[X],OC[Y],OC[Z])]);
                    OL[X]=(x[IX(OC[X],OC[Y],OC[Z])]+ const_bk)*exp(-ratio_k * delta_t)-const_bk;
					if (OL[X]>x[IX(OC[X]+1,OC[Y],OC[Z])]) OL[X]=x[IX(OC[X]+1,OC[Y],OC[Z])];
				  }
				else
...
void YLOCATION(PARA_DATA *para, REAL **var, REAL *flag, REAL *y, REAL v0, int i, int j, int k,  REAL *OL, int *OC, int *LOC , int *COOD)
	{
          ...
          if(OL[Y]<=y[IX(OC[X],OC[Y],OC[Z])]&& LOC[Y] == 1)
	        {  OC[Y] -=1;
              ...
              {  
			   ...
			   if(v[IX(OC[X],OC[Y]+1,OC[Z])]>0 && v[IX(OC[X],OC[Y]+1,OC[Z])] != v[IX(OC[X],OC[Y],OC[Z])] )
			      {
				...
				//	if( j==2 && k==20) printf("iteration %d \t %f \t %f \t %f \t %f \t %f\n", OC[Y],OL[Y],y[IX(1,1,1)], delta_t, ratio_k, const_bk );
			      }
			   else
	   ...
	   {
	       if(OL[Y]>y[IX(OC[X],OC[Y]+1,OC[Z])]&& LOC[Y] == 1)
           {
	          OC[Y] +=1;
			  if(OL[Y] <=y[IX(OC[X],OC[Y]+1,OC[Z])]) COOD[Y]=0;
              if(flag[IX(OC[X],OC[Y]+1,OC[Z])]>0)
              {  
	            delta_t= (dt- (y[IX(i,j,k)]-y[IX(OC[X],OC[Y],OC[Z])])/v0)*tratio;
	            ratio_k= (v[IX(OC[X],OC[Y]+1,OC[Z])]-v[IX(OC[X],OC[Y],OC[Z])])/(y[IX(OC[X],OC[Y]+1,OC[Z])]-y[IX(OC[X],OC[Y],OC[Z])]);
				if(v[IX(OC[X],OC[Y],OC[Z])]<0 && v[IX(OC[X],OC[Y]+1,OC[Z])] != v[IX(OC[X],OC[Y],OC[Z])])
				   {
                     const_bk= (v[IX(OC[X],OC[Y],OC[Z])]*y[IX(OC[X],OC[Y]+1,OC[Z])]-v[IX(OC[X],OC[Y]+1,OC[Z])]*y[IX(OC[X],OC[Y],OC[Z])])/(v[IX(OC[X],OC[Y]+1,OC[Z])]-v[IX(OC[X],OC[Y],OC[Z])]);
                     OL[Y]=(y[IX(OC[X],OC[Y],OC[Z])]+ const_bk)*exp(-ratio_k * delta_t)-const_bk;
					 if (OL[Y]>y[IX(OC[X],OC[Y]+1,OC[Z])]) OL[Y]=y[IX(OC[X],OC[Y]+1,OC[Z])];
				   }
				else
...
void ZLOCATION(PARA_DATA *para, REAL **var, REAL *flag, REAL *z, REAL w0, int i, int j, int k,  REAL *OL, int *OC, int *LOC , int *COOD)
	{
          ...
          if(OL[Z]<=z[IX(OC[X],OC[Y],OC[Z])]&& LOC[Z] == 1)
	        {  OC[Z] -=1;
              ...
              {  
			   ...
			   if(w[IX(OC[X],OC[Y],OC[Z]+1)]>0 && w[IX(OC[X],OC[Y],OC[Z]+1)] != w[IX(OC[X],OC[Y],OC[Z])])
			      {
					...
					if (OL[Z]<z[IX(OC[X],OC[Y],OC[Z])]) OL[Z]=z[IX(OC[X],OC[Y],OC[Z])];
			      }
			   else
	   ...
	   {
	       if(OL[Z]>z[IX(OC[X],OC[Y],OC[Z]+1)]&& LOC[Z] == 1)
           {
			  // printf("iteration z");
	          OC[Z] +=1;
			  if(OL[Z] <=z[IX(OC[X],OC[Y],OC[Z]+1)]) COOD[Z]=0;
              if(flag[IX(OC[X],OC[Y],OC[Z]+1)]>0)
              {  
	            delta_t= (dt- (z[IX(i,j,k)]-z[IX(OC[X],OC[Y],OC[Z])])/w0)*tratio;
	            ratio_k= (w[IX(OC[X],OC[Y],OC[Z]+1)]-w[IX(OC[X],OC[Y],OC[Z])])/(z[IX(OC[X],OC[Y],OC[Z]+1)]-z[IX(OC[X],OC[Y],OC[Z])]);
				if(w[IX(OC[X],OC[Y],OC[Z])]<0 && w[IX(OC[X],OC[Y],OC[Z]+1)] != w[IX(OC[X],OC[Y],OC[Z])])
				   {
			         const_bk= (w[IX(OC[X],OC[Y],OC[Z])]*z[IX(OC[X],OC[Y],OC[Z]+1)]-w[IX(OC[X],OC[Y],OC[Z]+1)]*z[IX(OC[X],OC[Y],OC[Z])])/(w[IX(OC[X],OC[Y],OC[Z]+1)]-w[IX(OC[X],OC[Y],OC[Z])]);
                     OL[Z]=(z[IX(OC[X],OC[Y],OC[Z])]+ const_bk)*exp(-ratio_k * delta_t)-const_bk;
					 if (OL[Z]>z[IX(OC[X],OC[Y],OC[Z]+1)]) OL[Z]=z[IX(OC[X],OC[Y],OC[Z]+1)];
				    }
				else
